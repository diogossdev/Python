...
#Testando função de transferência
valor_transferencia = float(input('Digite o valor da transferência de Victória para Diogo: '))
vivi.transferencia(diogo, valor_transferencia)
print(vivi)
print(diogo)
